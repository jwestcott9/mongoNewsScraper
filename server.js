...
app.post("/savedArticles/:id", function(req, res){
  db.Article.findOne({_id: req.params.id}).then(function(result){
    ...
    db.savedArticles.create(data).then(function(created){
      console.log(created);
      res.json(created);
     }); 
  });
...
app.post("/saveArticleNotes/:id", function(req, res) {
  ...
  db.Note.create(req.body)
    .then(function(dbNote) {
      ...
      return db.savedArticles.findOneAndUpdate({ _id: req.params.id }, { note: dbNote._id }, { new: true });
    })
    .then(function(dbArticle) {
...
app.delete("/deleteSaved/:id", function(req, res){
  db.savedArticles.remove({_id:req.params.id})
  .then(function(dbArticle){
    res.json(dbArticle);
  })
  .catch(function(err){
